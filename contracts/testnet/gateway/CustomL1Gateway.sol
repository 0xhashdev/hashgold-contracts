...
import { ArbitrumEnabledToken } from "@arbitrum/token-bridge-contracts/contracts/tokenbridge/ethereum/ICustomToken.sol";
 ...
 */
contract CustomL1Gateway is L1ArbitrumExtendedGateway, ICustomGateway {
    ...
    constructor(
        ...
        require(_l2Counterpart != address(0), "INVALID_COUNTERPART");
        require(counterpartGateway == address(0), "ALREADY_INIT");
        counterpartGateway = _l2Counterpart;
        router = _l1Router;
        require(_l1Router != address(0), "BAD_ROUTER");
    ...
    function inboundEscrowTransfer(
        ...
        IArbTokenL1(_l1Token).bridgeMint(_dest, _amount);
    }
    ...
    function outboundEscrowTransfer(
        ...
        IArbTokenL1(_l1Token).bridgeBurn(_from, _amount); // .safeTransferFrom(_from, address(this), _amount);
        // uint256 postBalance = IERC20(_l1Token).balanceOf(address(this));
        return _amount; // return SafeMath.sub(postBalance, prevBalance);
    }
}